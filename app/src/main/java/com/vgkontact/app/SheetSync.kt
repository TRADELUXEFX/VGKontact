...
object SheetSync {
     ...
     * viewers rows (free / purchased / referred) plus the group ids.
     * The free row is home-group only and also drives the
     ...
     * from other already-backgrounded code in this file without nesting
     * another background dispatch.
     */
     ...
     * the home group and the extra groups separate.
     */
