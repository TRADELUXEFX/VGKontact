...
object SheetSync {
    ...
    /** Everything the main menu's viewers block needs, from ONE server call. */
     ...
     * (free / purchased / referred). Callback gets null on any failure or
     * an empty result, so the caller can fall back to the individual calls.
     */
